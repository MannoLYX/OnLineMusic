			...
			<div id="bg">
						...
						<div class="entry">
							...
							<div align="center">
								<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
									...
									<param name="movie"
										value="mp3player.swf?config=config_2.xml&file=xml\${ mUser.memberId}.xml?<%=new Random().nextInt() %>" />
									<embed
										src="mp3player.swf?config=config_2.xml&file=xml\${ mUser.memberId}.xml?<%=new Random().nextInt() %>"
				...
				<div id="sidebar">
					<div id="about-box" style="font-size: 12px">
						...
						<p>
							您有("<font color=red><strong>" +2 + "</strong></font>")%>封未读短消息，请
