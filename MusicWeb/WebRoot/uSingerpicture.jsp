...
<style type="text/css">
	...
	#urlInfo {
		position: absolute;
		background: url(images/show_pic/r.gif) no-repeat 0 4px;
		visibility: hidden;
		z-index: 30000;
		padding-left: 12px;
		cursor: pointer;
...
setTimeout(function() {
	m3D.init(
		[ 
			...
			{ src: 'wf.jpg', url: '', title: 'jump to random script', color: '#fff' },
			{ src: 'avril.jpg' },
			{ src: 'cyx.jpg' },
			{ src: 'dzq.jpg' },
			{ src: 'exo.jpg' },
			...
			{ src: 'kuaizixd.jpg' },
			{ src: 'huangxiaoming.jpg', url: '', color: '#fff' }
		]
	);
}, 500);
</script>
