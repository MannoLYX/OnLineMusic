				...
				<table>
					...
					<tr>
						...
						<td><input name="mUser.gender" type="radio"
							easyform="length:2-16" checked="checked" value="男" />男
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
							name="mUser.gender" easyform="length:2-16" type="radio" value="女" />女
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="mUser.birthday" type="text"
							readonly="readonly" easyform="length:2-16" message="生日"
							easytip="disappear:lost-focus;theme:blue;"
							onclick="WdatePicker()" />
						</td>
					</tr>
				...
				<table>
					...
					<tr>
						...
						<td><input name="singerGender" type="radio"
							easyform="length:2-16" checked="checked" value="男" />男
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
							name="singerGender" easyform="length:2-16" type="radio" value="女" />女
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
							name="singerGender" easyform="length:2-16" type="radio"
							value="组合" />组合
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					</tr>
